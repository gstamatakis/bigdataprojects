...
public class InteractiveQueriesRestService {
    ...
    InteractiveQueriesRestService(final KafkaStreams streams, final HostInfo hostInfo) {
    ...
    public KeyValueBean byKey(@PathParam("storeName") final String storeName, @PathParam("key") final String key) {
        ...
        final ReadOnlyKeyValueStore<String, String> store = streams.store(storeName, QueryableStoreTypes.<String, String>keyValueStore());
        if (store == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public HostStoreInfo streamsMetadataForStoreAndKey(@PathParam("storeName") String store, @PathParam("key") String key) {
     ...
     */
    private List<KeyValueBean> rangeForKeyValueStore(final String storeName, final Function<ReadOnlyKeyValueStore<String, String>, KeyValueIterator<String, String>> rangeFunction) {
